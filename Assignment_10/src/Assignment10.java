 ...
 * Description: This class represents the UI for the customer management system. Allows the user to add customers, check out customers, list queues, release customers from loan officers, assign customers to loan officers, and display the menu.
...
public class Assignment10
{
    public static void main (String[] args) throws IOException
    {
        ...
        //in order to instantiate an object of the CustomerManagement class
        do
        {
